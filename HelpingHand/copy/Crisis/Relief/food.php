...
$sql = "SELECT T1.FOODRELEIFID as a,T1.COST as b,T1.RELIEFID as c ,disaster.CATEGORY as d FROM 
(SELECT food.FOODRELEIFID,relief.DISASTERID,food.COST,food.RELIEFID FROM food,relief WHERE food.FOODRELEIFID=relief.RELIEFID )
as T1,disaster WHERE disaster.DISASTERID=T1.DISASTERID";
$result = mysqli_query($conn, $sql);

echo "<table border='1'>
<tr>
<th>Food Relief Id</th>
<th>Total Cost</th>
<th>Crisis</th>
